...
void solve()
{
    ...
    int sumeve = accumulate(all(eve), 0ll);
    int sumodd = accumulate(all(odd), 0ll);
    int sumall = sumeve + sumodd;
    ...
    // if all sumgoes to odd .. all even is 0;
    int half = n / 2;

    if (sumall % half == 0 and (sumall / half) % 2 == 1)
    {
        YES;
        return;
    }

    /// id all sum goes to even ... all odd is 1 ;
    int sum = sumall - half;

    if (sum % half == 0 and (sum / half) % 2 == 0)
    {
        YES;
        return;
    }
    NO
        ...
        // if(sumall%(n/2)==0 and (sumall/(n/2))%2==1 ){
        //     YES;
        //     return;
        // }
        // if( (sumall - n/2)%(n/2)==0 and (sumall - n/2)%(n/2)==0 ){
        //     YES;
        //     return;
        // }
        // NO
        // dbg(sumodd , sumeve);
        // if(sumodd%4!=0 or sumeve%4!=0){
        // 	NO
        // 	return;
        // }else{
        // 	YES
