...
void solve(){    
        ...
        // int c1 = one - min(one , minus);
        // int c2 = minus - min(one , minus);
        // if( abs(c1-c2)>2){
        // 	No return;
        // }
        ...
        while(true){
        	one--;
        	if(one <= 0 and minus >2) break;
        	if(one <=0 and minus<=2) {ans = true;break;}
        	if(one <=2 and minus<=0) {ans = true;break;}
        ...
        // int one = 
        // int onesz = one.sz - min(one.sz , minus.sz); 
        // int minusz = minus.sz - min(one.sz , minus.sz);
        // int diff = abs(onesz - minusz);
        // if(diff<=2){
        // 	Yes
        // }else{
        // 	No
