...
void solve(){    
      ...
      //   	if(hash[1]==0){
        ...
        // while(true){
        // 	li = fi + mx - 1;
        // 	auto itf = lower_bound(all(vev),fi);
        // 	if(itf == vev.end() ){
        // 		break;
        // 	}
        // 	auto itl = lower_bound(all(vev),li);
        // 	// if(itl == vv.end()){
        // 	// 	break;
        // 	// }
        // 	if(*itf == fi and *itl == li){
        // 		ans++;
        // 		itf++;
        // 	}
        // 		fi = *itf;
    ...
    //     int ans =0;
    // // int maxxx = max_element(all(v));
    //     int maxxx = imin;
    //     trav(i,v){
    //     	maxxx = max(maxxx,i);
    //     }
    // for (int i = mx+1; i <=maxxx; ++i){
    // 	int t = mx;
    // 	int j = i;
    // 	bool ch = true;
    // 	while(mx--){
    ...
    return;
        ...
        // while(!vv.empty() and vv.front()!= mx +1){
        // 	vv.pop_front();
        // }
        // dbg(vv);
        // deque<int> dq;
        // while(!vv.empty()){
        // 	if(dq.sz ==mx and dq.back() - dq.front()== mx-1 ){
        // 		ans++;
        // 	}
        // 	if(dq.sz > mx)
		      //   dq.pop_front();
        ...
        // 	int num = vv.front();
        // 	// int need = num - mx -1;
        // 	// while(!dq.empty() and dq.front()<need){
        // 	// 	dq.pop_front();
        // 	// }
        // 	vv.pop_front();
        // 	dq.pb(num);
