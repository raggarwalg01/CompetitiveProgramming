...
/******************************************************************************************
        ...
        ans = {   1073 (1) 1072 (2) 1070 (3) 1067  (4) 1063 (5) 58 (6)    ... . . .  } * 2 
...
void solve(){    
        ...
        while(t--){
            ...
            auto temp = ub(all(v),x) - v.begin();
            // cout<< *(temp + v.begin() -1 ) spcend;
            if(  (x) == *(temp+ v.begin() -1) ){
                temp--;
            }
...
//         int discriminant =  1 + 8*c;

//         int x1 = 0;
//         x1 = (-1 + sqrt(discriminant)) / (2);
//         // int x2 = (-1 - sqrt(discriminant)) / (2);
// // cerr << x1 spcend;
//         // cout<< max(x1,x2)*2 ndl;
//         // x1++;
//         if( sqrt(discriminant)*sqrt(discriminant) == discriminant){
//          x1--;
//         }
//         // cout
//         cout<< 2*x1 ndl;
