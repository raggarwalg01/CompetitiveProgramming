...
void solve(){    
        ...
        for(int x1 = a ; ; x1++){
        	...
        	// int possibley = ((1.0)*(-b*x1))/(a - x1);
        	// if(possibley == b) {
        	// 	// cout<< possibley spc ((1.0)*(-b*x1))/(a - x1) spcend;
        	// 	break;
        	// }
        	// int possiblex = ceil_div(a*possibley, possibley - b);
        	// x1 = max(possiblex, x1);

        	// double temp = b;
        	// double yiee = (-b*x1*1.0)/(a-x1);
        	// int yie = yiee;
        	// if(yie < b ) break;
        	// int tx = ceil_div(((a - x1 )*1.0*(1ll*(yie))),(-b));
        	// // cout<< tx spcend;
        	// x1 = max(tx-1, x1);
        	// // cout<< yie ndl;
        	// // if( ( yie <0 ) and ypos == true) break;
        	// if(x1==1e7) break;
        }
        ...
        // for(int y = b+1 ; y <=maxy; y++){

        // }


        int maxx = temp[temp.sz - 1].fi;
        int miny = temp[temp.sz - 1].se;
