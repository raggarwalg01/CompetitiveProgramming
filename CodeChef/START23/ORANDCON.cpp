...
void presolve(){    
        ...
        // cout<< decimalToBinary(2) spc decimalToBinary(4) spc decimalToBinary(3) ndl;
...
void solve(){    
        ...
        int a = binaryToDecimal(as);

        string cs = decimalToBinary(n);
        nn = cs.length();
        reverse(all(cs));
