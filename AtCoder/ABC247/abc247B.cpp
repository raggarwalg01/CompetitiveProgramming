...
// #define vectorpairi                 vector <pair<int, int>>
...
void solve(){    
       ...
       int n;
    cin>>n;
    vector<pair<string,string>> vectorpair{};  
    string a,b;
    for(int i=0;i<n;i++){
        cin>>a>>b;
        vectorpair.pb({a,b});
    ...
    for(int i=0;i<n;i++){
        ...
        for(int j=0;j<n;j++){
            if(i==j) continue;
                ...
                if(vectorpair[i].fi==vectorpair[j].fi or vectorpair[i].fi==vectorpair[j].se){
                    p=1;
                }
                if(vectorpair[i].se==vectorpair[j].fi or vectorpair[i].se==vectorpair[j].se){
                    q=1;
                }
            }
        }
