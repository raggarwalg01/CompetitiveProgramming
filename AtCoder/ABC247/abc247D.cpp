       ...
       while(q--){
	       ...
	       if(type==1){
	       	...
	       	while(true){
	       		pi pair = dq.front();
	       		dq.pop_front();
	       		int numberonball = pair.fi;
	       		int countofball = pair.se;
	       		
	       		if(countofball <=ballremove){
	       			// yes
	       			sum = sum + countofball*numberonball;
		       		ballremove = ballremove - countofball;
	       		}else{
	       			countofball = countofball - ballremove;
	       			dq.push_front({numberonball,countofball});
	       			sum = sum + ballremove*numberonball;
	       			ballremove = 0;
	       		}
	       		if(ballremove ==0 ) break;
