...
void solve(){    
        ...
        int n , m ,q;
        cin>>n>>m>>q;
        bitset< (4000) +1 > abit[n+1],bbit[m+1];
        vi a(n),b(m);
        cin>>a>>b;
        rep(i,0,n){
            int num = a[i];
            ...
            // cout<<abit[i] ndl;
            // cout<< num ndl;
            // // if(abit[i][num]==1) abit[i][num]= 1;
            // // else 
            // abit[i-1][num] = 1;
            // // abit[i][num] = abit[i][num] ^ abit[i][num];
            // if(i!=0)
            //     abit[i] = abit[i-1] ^ (abit[i]);
        }
        // cout<<abit[n];
        // return;
        ...
        rep(i,0,m){
            ...
            // int num = b[i-1];
            // // if(bbit[i][num]==1) bbit[i][num]= 1;
            // // else 
            // bbit[i][num] = 1;
            // // bbit[i][num] = 1;
            // // bbit[i][num] = bbit[i][num]^ bbit[i][num];
            // if(i!=0)
            //     bbit[i] = bbit[i-1] ^ (bbit[i]);
        }
        ...
        while(q--){
            ...
            // cout<<bbit[l2-1] ndl;
            // cout<<bbit[r2] ndl;
            cout<< ( (abit[l1-1]^abit[r1])^(bbit[l2-1]^bbit[r2]) ).count() ndl;
        }
