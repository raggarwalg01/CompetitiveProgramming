...
void solve(){    
        ...
        set<pair<int,pair<int,int>>> hash1,hash2;
        ...
        rep(i,0,n){
        	rep(j,0,n){
        		...
        		// if( (i+j)%2==0 ){
	        	// 	hash1.insert({sum,{i+1,j+1}});
        		// }else{
        		// 	hash2.insert({sum,{i+1,j+1}});
        		// }
        	}
        }
        rep(i,0,n){
        ...
        cout<<m1+m2 ndl;
        cout<<a1 spc a2 spc b1 spc b2 ndl;

        // dbg(hash1);
        // auto ans1 = *hash1.rbegin();
        // auto ans2 = *hash2.rbegin();

        // int val = ans1.fi + ans2.fi;
        // cout<<val ndl;
        // cout<<ans1.se.fi spc ans1.se.se spc ans2.se.fi spc ans2.se.se ndl; 
