...
void solve(){    
  ...
  if(s.find("aba") != string::npos or s.find("aca") != string::npos)
  {
    cout << 3;
    return;
  }
  if(s.find("abca") != string::npos or s.find("acba") != string::npos)
  {
    cout << 4;
    return;
  }
  if(s.find("abbacca") != string::npos or s.find("accabba") != string::npos)
  {
    cout << 7;
    return;
  }
