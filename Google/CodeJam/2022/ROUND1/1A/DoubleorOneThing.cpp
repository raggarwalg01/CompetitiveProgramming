...
vector<string> genrateeeee;
void genratee(string &s, string nns, int i , int n ){
	if(i==n){
		genrateeeee.pb(nns);
		return;
	}
...
void solve(){    
    ...
    while(i<n){
        if(s[i]==s[i-1]){
            ...
            for(int k=0;k<answercounter;k++){
                ans.pb(s[i-1]);
            }
            answercounter=1; 
        }
        else{
            for(int k=0;k<2*answercounter;k++){
                ans.pb(s[i-1]);
            }
            answercounter=1;
        }
    ...
    // genrateeeee.clear();
    // string nns;
    //     genratee(cpy,nns, 0 , cpy.length());
    //     sort(all(genrateeeee));
        // char schar = s[n-1];
        // int ct = 0;
        // int id = n-1;
        // while(!s.empty() and s[id]==schar){
        // 	s.pop_back();
        // 	ct++;
        // 	id--;
        // }
        ...
        // 	s.pb(schar);
        // }
        // if(ans==genrateeeee[0]){
        // }else{
        	// cout<<genrateeeee[0] spcend;
        	// cout<<s spcend;
        	// cout<<"################################333" ndl;
        // }
        // return;
        ...
        // vector<string> aa = {"CCODDEEJAAMDAAY","CCODDEEJAAMDDAAY","CCODDEEJAMDAAY"};
        // sort(all(aa));
        // cout<<aa ndl;
        // string nsss= s;
        // sort(all(nsss));
